...
heart1_imag=loadimage("photos/hearts.png")
}
function setup() {
  var canvas = createCanvas(1200,400);
   ...
   for(var i;i>200;i=i+10){
    var heart1=createSprite(i,80,10,10)
...
if(keyDown("space")&&axe===false&&player2.y>=324.75){
  flag1=1;
   trident1.velocityX=50;
   player2.velocityY=-15
 }
 if(keyDown("space")&&axe===false&&player1.y<327&&player2.y>=324.75){
  flag1=1;
   trident1.velocityX=50;
   player2.velocityY=0;
 }
